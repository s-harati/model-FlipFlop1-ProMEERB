...
public class Registrar {
	...
	private void readCouplingMessage() throws IOException {
        ...
        String[] myLine1Split, myLine2Split, myLine3Split;
		...
		// second line is revenues info for U's
        ...
        tempCounter = 0; 
		for (AgentU agentU : agentUArray) {
			couplingRevenue = Double.parseDouble(myLine2Split[tempCounter]);
			agentU.setCouplingRevenue(couplingRevenue);
			tempCounter++; 
		}
        // third line is health score for G
        myLine3 = myBR.readLine();
        // debugging
        System.out.println("In Registrar.readCouplingMessage. myLine3: "+myLine3);
        // end of debugging
        myLine3Split = myLine3.split(" ");
        couplingScore = Double.parseDouble(myLine3Split[0]); // reminder: Line2 has only 1 number
