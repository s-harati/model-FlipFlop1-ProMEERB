...
public class AgentU {
	...
	private double couplingCost, couplingRevenue; // coupling
	...
	public void setCouplingRevenue(double couplingRevenue) {
		this.couplingRevenue = couplingRevenue;
	}
	...
	public void makeDecision() {
		...
		this.setDecision( ((uniqueness * value / maxSums) + this.couplingRevenue > this.threshold + this.couplingCost) ? 1 : 0 ); // couplingCost added
		// debugging
...
//		// test
		...
		System.out.println("uniqueness: "+uniqueness+" , value: "+value+
				...
				" , couplingRevenue: "+couplingRevenue+" , couplingCost: "+couplingCost+
				" , decision: "+decision);
		System.out.println("***");
//		// end test
	}
